...
public class LoginControllerTest {
	...
	@Test
	public void testShowLoginPageWithErrorMsg() throws Exception {

		this.mockMvc.perform(get(LoginController.URL_LOGIN_PAGE).accept(MediaType.TEXT_HTML).sessionAttr(WebAttributes.AUTHENTICATION_EXCEPTION, "msgErreur")).andExpect(status().isOk())
				.andExpect(view().name("login")).andExpect(model().attributeExists("errorMsg"));
	}
